...
See more about parameters used to instantiate `ValidationColumnConfig` in the [code reference](/code-reference/config/column-configs#data_designer.config.column_configs.ValidationColumnConfig).
...
- [Validator Parameters Reference](/code-reference/config/validator-params): Configuration object schemas
